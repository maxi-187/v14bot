  ...
  callback: async (client, interaction) => {
    ...
    try {
      ...
      const ticket = await guild.channels.create({
        ...
        const pembed = new EmbedBuilder().setTitle('Folgendes Problem besteht:').setDescription(problem).setFooter({ text: '© RG System' }).setTimestamp();
        ...
        channel.send({ embeds: [pembed], components: [button] }).catch(error => { return; });
