...
module.exports = {
  ...
  callback: async (client, interaction) => {
    ...
    try {
      const modalCollector = await interaction.awaitModalSubmit({
        time: 60000,
      });
      ...
      if (!givenAnswer || isNaN(givenAnswer)) {
        return modalCollector.reply({
          embeds: [
            new EmbedBuilder()
              .setDescription(
                "Du hast keine oder eine ungültige Zahl angegeben!"
              )
              .setColor("Red"),
          ],
          ephemeral: true,
          ...
          return interaction.member.roles
            ...
            .then(() => {
              return modalCollector.reply({
                embeds: [
                  new EmbedBuilder()
                    .setDescription("Erfolgreich verifiziert!")
                    .setColor("#57F287"),
                ],
                ephemeral: true,
              });
            ...
            .catch((error) => {
              ...
              return modalCollector.reply({
                embeds: [
                  new EmbedBuilder()
                    .setDescription("Es ist ein Fehler passiert!")
                    .setColor("Red"),
                ],
                ephemeral: true,
              });
