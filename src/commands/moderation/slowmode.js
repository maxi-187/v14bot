...
module.exports = {
  name: "slowmode",
  description:
    "Verringert die Geschwindigkeit, mit der Nachrichten gesendet werden können.",
  options: [
    {
      name: "rate",
    ...
    },
    {
      name: "zeit",
      description:
        "Geben Sie eine Dauer für den Slowmode an, z.B. 5s, 1m, 30m, usw.",
      type: ApplicationCommandOptionType.String,
      required: true,
    },
  ],
  ...
  callback: async (client, interaction) => {
    ...
    if (rate < minRate || rate > maxRate) {
      response.setDescription(
        `Die Geschwindigkeit muss zwischen ${ms(minRate, {
          long: true,
        })} und ${ms(maxRate, {
          long: true,
