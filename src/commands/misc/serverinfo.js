...
module.exports = {
  ...
  callback: async (client, interaction) => {
    ...
    const owner = guild.ownerId
      ? client.users.cache.get(guild.ownerId).toString()
      : "Unbekannt";
      ...
      embeds: [
        new EmbedBuilder()
          ...
          .addFields(
            ...
            {
              name: "Funktionen",
              value: guild.features.join(", ") || "Keine Funktionen",
              inline: true,
            },
            {
              name: "Boost-Level",
            ...
            {
              name: "Einladungslink",
              value: `[discord.gg](${invlink})` || " ",
              inline: true,
            },
            {
              name: "Kanäle",
              value: `Text: ${textChannels.size}\nSprach: ${voiceChannels.size}`,
              inline: true,
            },
            {
              name: "Server-Symbol",
              value: `[Server URL](${serverIcon})` || "Kein Server-Symbol",
              inline: true,
            },
            { name: "Bot-Präfix", value: "/", inline: true },
            {
              name: "Mitglieder",
              value: `Gesamt: ${guild.memberCount}\nMenschen: ${
            ...
            {
              name: "Rollen",
              value: guild.roles.cache.size.toString() || "0",
              inline: true,
            }
          )
