      ...
      embeds: [
        new EmbedBuilder()
          ...
          .addFields(
            ...
            {
              name: "Avatar",
              value: `[Avatar URL](${targetUser.displayAvatarURL({
                dynamic: true,
              })})`,
              inline: true,
            },
            {
              name: "Höchste Rolle",
              value: `${highestRole ? `<@&${highestRole.id}>` : "Keine Rolle"}`,
              inline: true,
            },
            {
              name: "Andere Rollen",
              value: `\`\`\`${otherRoles || "Keine anderen Rollen"}\`\`\``,
              inline: false,
            },
            {
              name: ":clock6: Konto erstellt:",
              value: `${targetUser.createdAt.toLocaleString()}`,
              inline: false,
            },
            {
              name: ":clock6: Server beigetreten:",
